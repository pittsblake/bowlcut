...
user = User.create!({name: 'Blake', email: 'taytay@gmail.com', password: 'blahblah', password_confirmation: "blahblah", image: "https://i.imgur.com/bs0FkJC.jpg?1"})
